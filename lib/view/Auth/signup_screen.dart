...
class _SignupScreenState extends State<SignupScreen> {
  ...
  void initState() {
    ...
    signupprovider.fullnamecontrollersignup.clear();
    signupprovider.emailcontrollersignup.clear();
    signupprovider.phonenumbercontrollersignup.clear();
    signupprovider.passswordcontrollersignup.clear();
    super.initState();
  }
